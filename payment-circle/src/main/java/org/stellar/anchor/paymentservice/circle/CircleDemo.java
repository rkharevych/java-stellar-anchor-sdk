...
public class CircleDemo {
  ...
  public static void main(String[] args) {
    ...
    //    System.out.println("_____________");
        ...
        // sendPayment(merchantAccount, userAccount, "circle:USD", BigDecimal.valueOf(10000)) // paymentCircleToCircle
        System.out.println("\n============= sendPayment(merchantAccount, userAccount, \"circle:USD\", BigDecimal.valueOf(10000)) // paymentCircleToCircle");
        Payment paymentCircleToCircle = service.sendPayment(merchantAccount, userAccount, "circle:USD", BigDecimal.valueOf(10000)).block();
        System.out.println("payment = " + gson.toJson(paymentCircleToCircle));
        System.out.println("_____________");

        // sendPayment(merchantAccount, stellarDestination, "circle:USDC...", BigDecimal.valueOf(100)) // paymentCircleToStellar
        System.out.println("\n============= sendPayment(merchantAccount, stellarDestination, \"circle:USDC...\", BigDecimal.valueOf(100)) // paymentCircleToStellar");
        Account stellarDestination = new Account(
        ...
        Payment paymentCircleToStellar = service.sendPayment(
            merchantAccount,
            stellarDestination,
            currencyName,
        ...
        // service.sendPayment(merchantAccount, wireDestination, currencyName, BigDecimal.valueOf(200)) // paymentCircleToWire
        System.out.println("\n============= sendPayment(merchantAccount, stellarDestination, \"circle:USDC...\", BigDecimal.valueOf(100)) // paymentCircleToWire");
        Account wireDestination = new Account(
                PaymentNetwork.BANK_WIRE,
                "a4e76642-81c5-47ca-9229-ebd64efd74a7",
                "marcelo@test.com",
                new Account.Capabilities());
        Payment paymentCircleToWire = service.sendPayment(
            merchantAccount,
            wireDestination,
            "iso4217:USD",
        ...
        DepositInstructions circleDepositInstructions = service.getDepositInstructions(requirements).block();
        System.out.println("circleDepositInstructions = " + gson.toJson(circleDepositInstructions));
        System.out.println("_____________");

        // getDepositInstructions(...) stellarDepositInstructions
        System.out.println("\n============= getAccountPaymentHistory(...) -> stellarDepositInstructions");
        requirements = new DepositRequirements("1000667920", PaymentNetwork.STELLAR, "circle:USD");
        DepositInstructions stellarDepositInstructions = service.getDepositInstructions(requirements).block();
        System.out.println("circleDepositInstructions = " + gson.toJson(stellarDepositInstructions));
        System.out.println("_____________");
